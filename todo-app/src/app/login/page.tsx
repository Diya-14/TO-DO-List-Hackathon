...
import { Loader2, CheckSquare, ArrowRight, ShieldCheck, Zap, Globe } from 'lucide-react';
        ...
        <div className="z-10">
          ...
          >
            <h1 className="text-6xl font-black leading-tight tracking-tight text-white">
              Master your <br />
              <span className="text-indigo-200">workflow.</span>
            </h1>
            <p className="mt-8 max-w-lg text-xl font-medium leading-relaxed text-indigo-100/80">
              The professional-grade task management system designed for high-performance teams and ambitious creators.
            </p>
          </motion.div>

          <div className="mt-12 grid grid-cols-2 gap-8">
            <FeatureItem icon={<ShieldCheck className="h-5 w-5" />} title="Secure" desc="Enterprise encryption" />
            <FeatureItem icon={<Zap className="h-5 w-5" />} title="Fast" desc="Real-time syncing" />
          </div>
        </div>

        <div className="z-10 flex items-center justify-between border-t border-white/10 pt-8 text-sm font-bold text-indigo-100/50">
          <span>© 2026 HackDo Global Inc.</span>
    ...
    return (
        <div className="flex gap-4">
            ...
            <div>
                ...
                <p className="text-xs text-indigo-100/60">{desc}</p>
            </div>
        </div>
    )
}